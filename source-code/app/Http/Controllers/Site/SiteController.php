...
class SiteController extends Controller
{
    public function index(){
        ...
        return view('site/index',['categories' => $categories,'equipmentsSearch' => json_encode(['search',$equipmentsSearch])]);
    }
    ...
    public function category(Request $request){
       ...
       $equipments = Equipments::where('category_id', $request['id'])->paginate(10);
        ...
        return view('site/equipments/index',['currentCategory' => $currentCategory,'categories' => Category::all(),'equipments' => $equipments,'equipmentsSearch' => json_encode(['search',$equipmentsSearch])]);
    }
    ...
    public function equipment(int $id){
        ...
        $category = Category::select(['name','id'])->where('id',$equipment->category_id)->first();
           ...
           return view('site/equipments/equipment',['equipment' => $equipment,'category' => $category,'categories' => Category::all(),'equipmentsSearch' => json_encode(['search',$equipmentsSearch])]);
    }
    ...
    public function search(Request $request){
        ...
        if($request->has('name')){
            ...
            return view('site/equipments/index',['currentCategory' => "Поиск",'categories' => Category::all(),'equipments' => $equipments,'equipmentsSearch' => json_encode(['search',$equipmentsSearch]),'searchName' => $request['name']]);
        }
        return  redirect('/');
    }
}
