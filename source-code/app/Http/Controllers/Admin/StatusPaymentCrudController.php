...
/**
 * Class StatusPaymentCrudController
 * @package App\Http\Controllers\Admin
 * @property-read \Backpack\CRUD\app\Library\CrudPanel\CrudPanel $crud
 */
class StatusPaymentCrudController extends CrudController
{
    ...
    {
        CRUD::setModel(\App\Models\StatusPayment::class);
        CRUD::setRoute(config('backpack.base.route_prefix') . '/status-payments');
    ...
    {
        CRUD::setValidation(StatusPaymentRequest::class);
